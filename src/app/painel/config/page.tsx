        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div className="border-t border-gray-700 pt-5">
            <div className="flex items-start gap-3 bg-purple-500/10 border border-purple-500/20 rounded-lg p-4 mb-4">
              <svg className="w-5 h-5 text-purple-400 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"></path></svg>
              <div>
                <p className="text-sm text-purple-300 font-bold mb-1">Autenticação 3DS 2.2 (Braspag MPI)</p>
                <p className="text-xs text-purple-400">Credenciais exclusivas para autenticação 3DS — diferentes do MerchantId acima. Habilite em: <strong>Portal Cielo → Produtos → 3DS 2.2</strong> para obter o ClientId e ClientSecret.</p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" value={clientId3ds} onChange={e => setClientId3ds(e.target.value)}
              ...
              <div>
                ...
                <input type="password" value={clientSecret3ds} onChange={e => setClientSecret3ds(e.target.value)}
                  className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-sm text-white font-mono outline-none focus:border-purple-600"
