          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-0 md:gap-8">
            ...
            <FooterAccordion id="atendimento" title="Atendimento">
              ...
              <div className="flex gap-3 mt-4">
                {/* WhatsApp */}
                <a href="https://wa.me/551155420500" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-800 hover:bg-[#25d366] rounded-lg flex items-center justify-center transition-colors" title="WhatsApp">
                ...
                {/* Facebook */}
                <a href="https://www.facebook.com/europcarbr/?ref=NONE_xav_ig_profile_page_web#" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-800 hover:bg-[#1877f2] rounded-lg flex items-center justify-center transition-colors" title="Facebook">
                ...
                {/* LinkedIn */}
                <a href="https://www.linkedin.com/company/europcar-brasil/?originalSubdomain=br" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-800 hover:bg-[#0a66c2] rounded-lg flex items-center justify-center transition-colors" title="LinkedIn">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/europcar_brasil/" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-gray-800 hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:to-[#833ab4] rounded-lg flex items-center justify-center transition-colors" title="Instagram">
