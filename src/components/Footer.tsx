    ...
    <footer className="bg-[#1a1a1a] text-gray-400 border-t border-gray-800">
      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <h4 className="text-white text-sm font-bold mb-3">Divisão de Negócios</h4>
            <ul className="space-y-2 text-xs mb-4">
              <li><a href="https://www.europcar.com/pt-br/business" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Contas Corporativas / Empresas</a></li>
              <li><a href="https://www.europcar.com/pt-br/partners/travel-agencies" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Agências de Viagens</a></li>
              <li><a href="https://www.europcar.com/pt-br/partners/tour-operators" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">Operadores de Turismo e OTA's</a></li>
            </ul>

            {/* Contact buttons */}
            <div className="flex flex-col gap-2 mt-4">
              <a href="mailto:contato@europcar.com.br" className="inline-flex items-center gap-2 bg-gray-800 hover:bg-gray-700 text-gray-300 hover:text-white text-xs font-bold px-3 py-2 rounded-lg transition-colors w-fit">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                E-mail
              </a>
              <a href="https://wa.me/5511999999999" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-[#25d366]/20 hover:bg-[#25d366]/30 text-[#25d366] text-xs font-bold px-3 py-2 rounded-lg transition-colors w-fit">
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.instagram.com/europcar" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors" title="Instagram">
              ...
              <a href="https://www.facebook.com/Europcar" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors" title="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              <a href="https://www.linkedin.com/company/europcar" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-white transition-colors" title="LinkedIn">
