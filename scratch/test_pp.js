...
const CALLER_CODE = "1132582";
const PASSWORD = "27112025";
const ENDPOINT = "https://applications-ptn.europcar.com/xrs/resxml";

async function testPP() {
    console.log("--- TESTANDO API EUROPCAR (PP - 1132582) ---");
    
    const pickupDate = "20260601";
    const returnDate = "20260608";
    const station = "VCPT02"; 

    const xmlRequest = `
<message>
  <serviceRequest serviceCode="getMultipleRates">
    <serviceParameters>
      <reservation carCategoryPattern="CDMR" rateDetails="Y" chargesDetail="TRE">
